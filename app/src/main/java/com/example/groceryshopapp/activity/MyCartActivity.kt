...
class MyCartActivity : BaseActivity(), GroceryCartListAdapter.RemoveFromCartClickListener,
    GroceryCartListAdapter.MinusButtonClickListener, GroceryCartListAdapter.PlusButtonClickListener {
    ...
    private fun setadapterData() {
        ...
        if (!myCartList.isNullOrEmpty()) {
            ...
            cartAdapter.setRemoveFromCartClickListener(this)
            cartAdapter.setMinusButtonClickListener(this)
            cartAdapter.setPlusButtonClickListener(this)
    ...
    override fun onclickPlusClick(position: Int, groceryItem: GroceryModel) {

        if (myCartList?.get(position)?.count>0) {
    ...
    override fun onclickMinusClick(position: Int, groceryItem: GroceryModel) {
